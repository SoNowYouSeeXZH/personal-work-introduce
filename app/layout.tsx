...
function Navbar() {
  return (
    <nav className="fixed left-0 right-0 top-0 z-50 border-b border-emerald-100 bg-[#fffdf8]/88 backdrop-blur-xl">
      <div className="mx-auto flex max-w-6xl items-center justify-between px-5 py-4 md:px-8">
        ...
        <div className="flex items-center gap-2">
          <Link
            href="/#gallery"
            className="hidden rounded-md px-3 py-2 text-sm font-bold text-slate-600 transition hover:bg-emerald-50 hover:text-emerald-700 sm:inline-flex"
          >
            相册
          </Link>
          <Link
            href="/#upload"
            className="inline-flex h-9 items-center rounded-md bg-rose-500 px-4 text-sm font-bold text-white transition hover:-translate-y-0.5 hover:bg-slate-900"
          >
            上传
          </Link>
        </div>
